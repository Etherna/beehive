    ...
    public sealed class PostageStampSchemaFilter : ISchemaFilter
    {
        public void Apply(IOpenApiSchema schema, SchemaFilterContext context)
        {
            ...
            if (context.Type == typeof(PostageStamp))
            {
                ...
                openApiSchema.MinLength = PostageStamp.StampSize * 2;
                openApiSchema.MaxLength = PostageStamp.StampSize * 2;
                openApiSchema.Pattern = $"^[a-fA-F0-9]{{{PostageStamp.StampSize * 2}}}$";
