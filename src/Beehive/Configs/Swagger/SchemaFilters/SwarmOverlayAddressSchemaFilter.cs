    ...
    public sealed class SwarmOverlayAddressSchemaFilter : ISchemaFilter
    {
        public void Apply(IOpenApiSchema schema, SchemaFilterContext context)
        {
            ...
            if (context.Type == typeof(SwarmOverlayAddress) || context.Type == typeof(SwarmOverlayAddress?))
            {
                ...
                openApiSchema.MinLength = SwarmOverlayAddress.AddressSize * 2;
                openApiSchema.MaxLength = SwarmOverlayAddress.AddressSize * 2;
                openApiSchema.Pattern = $"^[a-fA-F0-9]{{{SwarmOverlayAddress.AddressSize * 2}}}$";
            }
        }
    }
}